...
import styles from './CheckInSuccessStyles';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.paddedView}>
        ...
        <Text style={{ textAlign: 'center', paddingBottom: 24 }}>
          Inspect the bike for any damage that may have occured during your
          trip. If there is any, please report it with the "Report Damage"
          button below.
        </Text>
      </View>
